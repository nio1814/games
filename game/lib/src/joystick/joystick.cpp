...
extern bool    g_bFilterOutXinputDevices = false;
extern XINPUT_DEVICE_NODE* g_pXInputDeviceList = NULL;
extern LPDIRECTINPUT8       g_pDI              = NULL;         
extern LPDIRECTINPUTDEVICE8 g_pJoystick        = NULL;
